         ...
         <div className="flex items-center justify-center min-h-screen bg-gray-50">
                <div className="w-full max-w-md p-8 space-y-8 border rouded-lg shadow-lg bg-white">
                    ...
                    <Form onSubmit={handleLogin} className="mt-8 space-y-6">
                        <InputField name="fullName" placeholder="Full Name" className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 foucs:z-10 sm:text-sm"/>
                        ...
                        <InputField name="confirmationPassword" type="email" placeholder="Confirmation Password" className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 foucs:z-10 sm:text-sm"/>
